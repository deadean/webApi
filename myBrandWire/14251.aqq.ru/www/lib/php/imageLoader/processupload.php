...
if(isset($_POST))
{
	...
	$DestinationDirectory	= $_SERVER['DOCUMENT_ROOT'].'/uploads/companyContacts/';
	...
	$RandomNumber 	= $idContact;

	$ImageName 		= $RandomNumber; //get image name
