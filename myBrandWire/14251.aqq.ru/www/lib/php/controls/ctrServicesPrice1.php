...
<script>
    function CountOrdersCost() {
        ...
        $('#idTotalRubCost').text(totalprice * c);
        ...
        $('#RubPriceService1').text(parseInt($('#DollarPriceService1').text()) * c);
        $('#RubPriceService2').text(parseInt($('#DollarPriceService2').text()) * c);
        $('#RubPriceService3').text(parseInt($('#DollarPriceService3').text()) * c);
        $('#RubPriceService4').text(parseInt($('#DollarPriceService4').text()) * c);
        $('#RubPriceService5').text(parseInt($('#DollarPriceService5').text()) * c);
        $('#RubPriceService6').text(parseInt($('#DollarPriceService6').text()) * c);
        $('#RubPriceService7').text(parseInt($('#DollarPriceService7').text()) * c);
        $('#RubPriceService8').text(parseInt($('#DollarPriceService8').text()) * c);
...
<div class=" container " style="position: relative;top:10">
    <div class=" adapteeNewsToTheMainNewsContainerServicesStyle">
        ...
        <div class="commonTextStyle clearfix mainServices" style="font-size:97%;">
            <input class="commonCheckBoxStyle" id="checkboxPublish" type="checkbox" name="checkboxPublish"
                   ...
                   <?php
                   if ($_POST["mode"] != "change" && (isset($_POST["checkboxPublish"]) || $_POST["mode"] == "edit")) {
            ...
            if (isset($_POST["checkboxPublish"]))
                echo "<script>document.getElementById('checkboxPublish').checked='true';</script>";
            ?>
        </div>
        <div class="commonTextStyle clearfix mainServices" style="font-size:97%;">
            ...
            <?php
            if (isset($_POST["checkboxSpelling"]))
                echo "<script>document.getElementById('checkboxSpelling').checked='true';</script>";
            ?>
    ...
    <div class="adapteeNewsToTheMainNewsContainerPrices">
        <div
            class="adapteeNewsToTheMainNewsContainerPricesItemCurrency adapteeNewsToTheMainNewsContainerPricesItemCurrencyRub"></div>
        <div class="adapteeNewsToTheMainNewsContainerPricesItem commonTextStyle" id="RubPriceService1">
        </div>
        <div class="adapteeNewsToTheMainNewsContainerPricesItem commonTextStyle" id="RubPriceService2">
        </div>
        <div class="adapteeNewsToTheMainNewsContainerPricesItem commonTextStyle" id="RubPriceService3">
        </div>
    </div>
    <div class="adapteeNewsToTheMainNewsContainerSeparator ">
        <div></div>
...
<div class=" container " style="position: relative;top:10">
    <div class=" adapteeNewsToTheMainNewsContainerServicesStyle" style="vertical-align: top;padding-top: 10">
        ...
        <div class="commonTextStyle clearfix mainServices" style="font-size:97%;">
            ...
            Соц Сети .............................................................................
            <?php
            if (isset($_POST["checkboxAddCompanySocialNetworks"]))
                echo "<script>document.getElementById('checkboxAddCompanySocialNetworks').checked='true';</script>";
            ?>
        ...
        <div class="commonTextStyle clearfix mainServices" style="font-size:97%;">
            ...
            О компании..........................................................................
            <?php
            if (isset($_POST["checkboxSocialNetworks6"]))
                echo "<script>document.getElementById('checkboxSocialNetworks6').checked='true';</script>";
            ?>
        ...
        <div class="commonTextStyle clearfix mainServices" style="font-size:97%;">
            ...
            Адрес компании...................................................................
            <?php
            if (isset($_POST["checkboxSocialNetworks7"]))
                echo "<script>document.getElementById('checkboxSocialNetworks7').checked='true';</script>";
            ?>
        ...
        <?php
        if (isset($_POST["checkboxSocialNetworks8"]))
            echo "<script>
                    document.getElementById('checkboxSocialNetworks8').checked='true';"
                    .$onClickCheckboxSocialNetworks8
                    .";ChangeSlideDownAnimation('idBlockContacts','name-help');
                    console.log('AJAX');
    ...
    <div class="adapteeNewsToTheMainNewsContainerPrices" style="vertical-align: top">
        <div class="adapteeNewsToTheMainNewsContainerPricesItemCurrency adapteeNewsToTheMainNewsContainerPricesItemCurrencyRub "></div>
        <div class="adapteeNewsToTheMainNewsContainerPricesItem commonTextStyle" id="RubPriceService5"></div>
        <div class="adapteeNewsToTheMainNewsContainerPricesItem commonTextStyle" id="RubPriceService6"></div>
        <div class="adapteeNewsToTheMainNewsContainerPricesItem commonTextStyle" id="RubPriceService7"></div>
        <div class="adapteeNewsToTheMainNewsContainerPricesItem commonTextStyle" id="RubPriceService8"></div>
    </div>
    <div class="adapteeNewsToTheMainNewsContainerSeparator "></div>
</div>

<div class=" container " style="position: relative;top:10">
    <div class=" adapteeNewsToTheMainNewsContainerServicesStyle">
        <div class="commonTextStyle clearfix totalCost greyText" style="font-size:97%;margin-left: 0">
            Обшая сумма заказа.........................................................
        </div>
    </div>
